...
public:
  ...
  */
  ...
  void FanAngleDetector(vtkImageData* frameImage, double &presetAngleLeft, double &presetAngleRight, double &outputAngleLeft, double &outputAngleRight, double &xOrigin, double &yOrigin);
